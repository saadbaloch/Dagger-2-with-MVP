...
import mvp.bhatti.com.mvplogin.di.DaggerMainComponent;
import mvp.bhatti.com.mvplogin.di.MainComponent;
...
public class MainActivity extends AppCompatActivity implements MainViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainComponent daggerMainComponent= DaggerMainComponent.builder().mainModule(new MainModule(this)).contextModule(new ContextModule(this)).build();
        daggerMainComponent.injectHomeActivity(this);
      //  setupMVP();
        setupViews();
        getMovieList();
    }
